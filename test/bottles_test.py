"""This the Python equivalent of
https://github.com/sandimetz/99bottles/blob/b-exercise/test/bottles_test.rb
from the https://www.sandimetz.com/99bottles book."""
import os
import sys
import unittest

sys.path = [os.path.join(os.path.dirname(__file__), os.pardir, "lib")] + sys.path
